...
def load_portfolio_data():
            ...
            if os.path.exists(filepath):
                with open(filepath, "r", encoding='utf-8') as f:
                    ...
                    if trading_mode == "real" and data:
                        ...
                        if binance_data and not binance_data.get("error") and binance_data.get("positions"):
                            return binance_data
                    return data
    ...
    if trading_mode == "real":
        binance_data = load_binance_as_portfolio()
        if binance_data and not binance_data.get("error"):
            return binance_data
...
with tab1:
    ...
    if not portfolio_data and not trade_history:
        st.info("📡 Nenhum dado de portfólio ainda. Os dados aparecerão aqui quando o bot executar trades.\n\nVeja a aba **📜 Histórico** e **📊 Signal Analytics** para sinais já gerados.")
    else:
        pass  # Continue with normal display below
