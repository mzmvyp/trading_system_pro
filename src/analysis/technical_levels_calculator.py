...
# Position sizing compensa automaticamente: SL maior = posição menor = mesmo risco em $.
# Combinado com leverage cap 10x: pior caso 10x*5% = 50% perda da margem (vs 100% antes).
